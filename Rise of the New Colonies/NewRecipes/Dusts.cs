...
namespace PhentrixGames.RiseoftheNewColonies.NewRecipes
{
    ...
    {
        public CopperDustRecipe() : base("stonecrusher.copperdust", "phentrixgames.stonecrusher", true, 10, 1)
        {
    ...
    {
        public IronDustRecipe() : base("stonecrusher.irondust", "phentrixgames.stonecrusher", true, 10, 1)
        {
            Requirements.Add(new InventoryItem("stonebricks", 1000));
