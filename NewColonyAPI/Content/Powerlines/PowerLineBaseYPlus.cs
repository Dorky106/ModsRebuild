...
namespace PhentrixGames.NewColonyAPI.Content.Powerlines
{
    ...
    public class PowerLineBaseYPlus : Types.BaseType, IUpdatedAdjacentType, ISingleBlockEntityMapping
    {
        public PowerLineBaseYPlus() : base("PowerLineBaseYPlus", false)
        {
            if (MeshManager.GetMesh(NewColonyAPIEntry.ModName, "newpowerline1", out string mesh))
            {
                this.Mesh = mesh;
            }
            this.MeshRotationEuler = new Pipliz.Vector3Int(180, 0, 90);
