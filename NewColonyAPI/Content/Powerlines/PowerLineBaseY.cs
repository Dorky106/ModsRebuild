...
namespace PhentrixGames.NewColonyAPI.Content.Powerlines
{
    ...
    public class PowerLineBaseY : Types.BaseType, IUpdatedAdjacentType, ISingleBlockEntityMapping
    {
        public PowerLineBaseY() : base("PowerLineBaseY", false)
        {
            if (MeshManager.GetMesh(NewColonyAPIEntry.ModName, "newpowerline2", out string mesh))
            {
                this.Mesh = mesh;
            }
